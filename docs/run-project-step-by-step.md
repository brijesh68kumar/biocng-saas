...
3. Dashboard plus module pages (feedstock + farmers live, others placeholder)
4. Logout button to end session
5. In `Feedstock Types` and `Farmers` pages you can create records and see list from backend API
