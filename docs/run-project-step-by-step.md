...
3. Dashboard plus module pages (feedstock + farmers + collection centers live, vehicles placeholder)
4. Logout button to end session
5. In `Feedstock Types`, `Farmers`, and `Collection Centers` pages you can create records and see list from backend API
